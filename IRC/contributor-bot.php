...
$irc->registerActionHandler( SMARTIRC_TYPE_CHANNEL, '#[0-9]+?\b', $doc_bot, 'trac_ticket' );
$irc->registerActionHandler( SMARTIRC_TYPE_CHANNEL, 'r[0-9]+?\b', $doc_bot, 'trac_changeset' );
